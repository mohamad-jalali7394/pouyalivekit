    ...
    handleTrackUnsubscribed(track, publication, participant) {
      ...
      if (this.remoteTracksMap.has(userId) && publication.kind === 'audio' && publication.source !== 'screen_share' && publication.source !== 'unknown') {
        ...
        if (this.room.remoteParticipants.get(participant?.identity)?.videoTrackPublications.size === 0){
          console.error('vvvvvvvvvvvvvvvvvvv1111111111111111111111111111111111111111111111111111111')
          ...
          console.error('vvvvvvvvvvvvvvvvvvvvv22222222222222222222222222222222222')
          ...
          if (hasVideoTrack){
            console.error('vvvvvvvvvvvvvv3333333333333333333333333333333')
            this.remoteTracksMap.set(userId, temp)
          }else {
            this.remoteTracksMap.delete(userId);
            console.error('vvvvvvvvvvvvvvvvvvvvv555555555555555555555555555555555')
          }
        }else {
          console.error('vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv666666666666666666666666666666666666')
          this.remoteTracksMap.set(userId, temp)
      ...
      if (publication.source === 'screen_share') {
        ...
        //   console.error('ccccccccccccccccccccccccccccc1111111111111111111111111111111111111111111111111111')
        //   this.remoteTracksMap.delete(userId);
        // }else if(this.room.remoteParticipants.get(participant?.identity)?.audioTrackPublications.size > 0) {
        //   console.error('ccccccccccccccccccccccccccccccccccc222222222222222222222222222222222222222')
        ...
        //       hasAudioTrack = true
        //       console.error('cccccccccccccccccccccccccccccccccccccccccc33333333333333333333333333333333333333333333')
        //     }
        //   }
        //   if (hasAudioTrack){
        //     console.error('ccccccccccccccccccccccccccccccc444444444444444444444444444444444444444')
        //     this.remoteTracksMap.set(userId, temp)
        //   }else {
        //     console.error('cccccccccccccccccccccccccccccccccc55555555555555555555555555555555555')
        //     this.remoteTracksMap.delete(userId);
        //   }
        //
        // }else {
